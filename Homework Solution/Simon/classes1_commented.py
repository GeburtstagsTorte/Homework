...
class Object:
    ...
    def take_money_and_evaluate_quantity(self):
        # Samuel: do you really need this function?
        try:
            current_money = int(input("give me the amount of money you currently have: "))
        except ValueError:
            print("It seems you made a mistake there...")
            pass # Samuel: i guess you should return the function call again because when you pass this it will simply continue
        # and this doesnt make any sense. But im not sure. vlad can certainly say more about that
...
class Person:
    current_carried_weight = 0 # Samuel: you dont use it?!
    ...
    def print_person(self):
        print('Player  |  Name: {} \n'
              ...
              '          Money: {} \n'
              ' max. c. weight: {} \n'
              '        objects: {} \n'.format(self.name, self.age, self.money, self.carry_weight, self.object)) # Samuel: i guess self.object wont work since it is a list with calls

people = [Person("Simon", 18, 500, 50, [Object("chair", 10, "blue", 49.99)]), Person("Samuel", 17, 500, 50, None )]# Samuel: should be []
...
def print_persons_details(people):
    ...
    for i in people:
        ...
        # some mistakes in here #Samuel: else?!
...
def main():
    while True:
        ...
        if x == "E":
            print("\nBye...")
            sys.exit("exit complete, thank you for participating") #Samuel: You dont have to import the whole library furthermore the text is supossed to be an error code so exit it with 0
        try:
            x = int(x)
        except ValueError:
            print("It seems you made a mistake")
            main() # Samuel: You are in an infinite loop..
